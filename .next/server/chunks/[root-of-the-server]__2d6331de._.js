module.exports = [
"[project]/.next-internal/server/app/api/keys/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/keys/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const apiKey = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$keys$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiKeyStore"].getById(id);
        if (!apiKey) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(apiKey);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request, { params }) {
    try {
        ...
        console.log('PUT /api/keys/[id] - All API keys:', __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$keys$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiKeyStore"].getAll());
        const updatedApiKey = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$keys$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiKeyStore"].update(id, {
            name,
            description,
            key,
            isActive
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedApiKey);
    } catch (error) {
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        const deleted = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$keys$2d$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiKeyStore"].delete(id);
        if (!deleted) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'API key not found'
            }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d6331de._.js.map