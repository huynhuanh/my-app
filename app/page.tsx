...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center animate-fade-in">
            {/* Logo/Icon */}
            <div className="w-24 h-24 mx-auto mb-8 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-xl">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              A modern, secure, and beautiful way to manage your API keys and access tokens. 
              Built with Next.js and styled with love.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
              <div className="card p-6 text-center group hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-gray-600 text-sm">Enterprise-grade security for your API keys</p>
              </div>
              ...
              <div className="card p-6 text-center group hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-gray-600 text-sm">Lightning-fast performance with modern tech</p>
              </div>
              ...
              <div className="card p-6 text-center group hover:shadow-lg transition-all duration-300">
                ...
                <h3 className="font-bold text-gray-900 mb-2">Beautiful</h3>
                <p className="text-gray-600 text-sm">Stunning UI with smooth animations</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                ...
                className="group btn-secondary flex items-center space-x-3 text-lg px-8 py-4"
              >
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-40 right-10 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse" style={{ animationDelay: '2s' }}></div>
      ...
      {/* Footer */}
      <footer className="relative bg-white/50 backdrop-blur-sm border-t border-gray-200/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-bold text-gray-900">API Keys Manager</span>
            </div>
